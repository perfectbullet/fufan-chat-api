...
def start_controller():
    ...
    uvicorn.run(controller_app, host="127.0.0.1", port=21001)
...
#     worker = ModelWorker(
#         controller_addr="http://127.0.0.1:21001",
...
#     uvicorn.run(worker_app, host="127.0.0.1", port=21002)
...
def start_openai_api_server():
    ...
    app_settings.controller_address = "http://127.0.0.1:21001"
